...
@Component({
  selector: 'app-ecommerce-confirmation',
            ...
            <div class="receipt-item">
              <div class="receipt-item-left">
                ...
                @if (item.variantColor || item.variantSize) {
                  <span class="receipt-item-variant">{{ variantLabel(item.variantColor, item.variantSize) }}</span>
                }
              </div>
  ...
  styles: `
    ...
    .check-icon { color: #fff; font-size: 26px; line-height: 1; }
    ...
    .payment-warning { width: 100%; font-weight: 800; font-size: 14px; color: oklch(48% 0.10 72); }
    .payment-desc { width: 100%; font-size: 13px; color: oklch(50% 0.01 30); line-height: 1.55; }
    ...
    .qr-scan-label { font-size: 12px; font-weight: 700; color: oklch(48% 0.10 72); }
    ...
    .receipt-item-name { font-size: 13px; color: oklch(50% 0.01 30); }
    .receipt-item-variant { font-size: 11.5px; color: oklch(65% 0.008 30); }
    .receipt-item-total { font-weight: 700; font-size: 13px; white-space: nowrap; }
    ...
    .form-error { margin: 0 0 12px; font-size: 13px; color: oklch(38% 0.13 22); text-align: left; width: 100%; }
...
export class EcommerceConfirmationComponent {
